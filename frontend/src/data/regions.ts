...
export const nationwideRegions: readonly CityRegion[] = [
  { name: "北京市", cities: ["北京市"] },
  { name: "天津市", cities: ["天津市"] },
...
export const nationwideCities = nationwideRegions.flatMap((region) => region.cities);

// 录入订单时常只写区县（如“武侯区xx小区”）而不写城市，用于把区县归并到所属城市。
export const cityDistricts: Record<string, readonly string[]> = {
  成都市: [
    "锦江区",
    "青羊区",
    "金牛区",
