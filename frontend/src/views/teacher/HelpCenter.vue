...
const faqs = [
  {
    question: "接单的完整流程是什么？",
    answer:
      "确认订单适合后先投递简历，并支付 100 元定金；简历通过后补齐信息费尾款，再与对接中介微信沟通试课时间。建议投递前先确认时间、地点、科目和课酬，避免通过简历后无法到岗。",
    actionLabel: "查看我的投递",
  ...
  },
  {
    ...
    answer:
      "100 元定金用于确认老师的投递意愿，避免中介与家长确认安排后老师单方面不去。定金是信息费的一部分，不会额外多收；简历未通过会全额退回。若在投递中或简历通过后因老师个人原因放弃，定金不予退还。",
  },
  {
    question: "信息费怎么计算？",
    answer:
